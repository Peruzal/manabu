...
exports.func = async function migrate(models) {
  ...
  const course = await Course.create({
    ...
    image: 'http://localhost:3005/uploads/Manabu_round_icon_extra01.png',
    rating: 3,
    description:
        'Learn the principles behind writing code that is easy to comprehend and maintain. This course will use Python as a programming language.',
  }).fetch();
  ...
  await addLesson({
    ...
    order: 0,
    markdown:
      'By working in a team of developers, it is imperative to write readable code.',
  }, allAuthors, allTags);
};
