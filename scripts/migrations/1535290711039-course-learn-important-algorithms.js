...
exports.func = async function migrate(models) {
  ...
  const course = await Course.create({
    ...
    image: 'http://localhost:3005/uploads/Manabu_Algorithm_round_icon.png',
    rating: 4.4,
    description:
        'We will have a look at some of the most common, and important, algorithms. For programming purposes, we will use Python.',
  }).fetch();
  ...
  await addLesson({
    ...
    source: 'http://localhost:3005/uploads/5dea3c1cfa6ae0c4cf9495c4-5df0fef11e52e654614163fc.mp4',
    course: course.id,
    durationInSeconds: 134,
    order: 100,
    markdown:
      'Let us look at a very simple example of an algorithm.',
  }, allAuthors, allTags);
};
