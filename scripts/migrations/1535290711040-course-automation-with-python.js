...
exports.func = async function migrate(models) {
  ...
  const course = await Course.create({
    ...
    image: 'http://localhost:3005/uploads/Manabu_Python_round_icon.png',
    rating: 4.5,
    description:
        'Let us begin our journey of automating simple tasks using the elegant programming language of Python.',
  }).fetch();
  ...
  await addLesson({
    ...
    course: course.id,
    durationInSeconds: 644,
    order: 0,
    markdown:
      'A brief look at the history of automation.',
  }, allAuthors, allTags);
};
