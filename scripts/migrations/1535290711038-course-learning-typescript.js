...
exports.func = async function migrate(models) {
  ...
  const course = await Course.create({
    ...
    image: 'http://localhost:3005/uploads/Manabu_round_icon_extra04.png',
    rating: 3.8,
    description:
        'In this short course, we will learn the basics of Typescript.',
  }).fetch();
  ...
  await addLesson({
    ...
    course: course.id,
    durationInSeconds: 647,
    order: 0,
    markdown:
      'We\'ll explain the differences between Javascript and Typescript.',
  }, allAuthors, allTags);
};
